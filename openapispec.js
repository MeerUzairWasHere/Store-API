const openApiSpec = {
  ...
  info: {
    title: "Store API",
    description:
      "An API to fetch products from the store, with filtering, sorting, and pagination features.",
    version: "1.1.0",
    contact: {
  ...
  servers: [
    {
      url: "https://store-api-hp1r.onrender.com",
  ...
  paths: {
    "/api/v1/products": {
      get: {
        ...
        description:
          "Retrieve a list of products with optional filters, sorting, and pagination.",
        tags: ["Products"],
        parameters: [
          {
            in: "query",
          ...
          },
          {
            ...
            description:
              "Filter products by numeric fields like price or rating using comparison operators.",
          ...
          },
          {
            ...
            description:
              "Sort products by field names, comma-separated (use '-' for descending order)",
            example: "price,-name",
          },
          {
            in: "query",
            ...
            description:
              "Limit the fields returned in the response, comma-separated",
